...
def generate_slides(request: PresentationRequest):
    ...
    try:
        ...
        presentation = slides_service.presentations().create(body={"title": request.title}).execute()
                ...
                requests.append({
                    "createSlide": {
                        ...
                        "placeholderIdMappings": [
                            {"layoutPlaceholder": {"type": "CENTERED_TITLE"}, "objectId": f"title_{i}"},
                            {"layoutPlaceholder": {"type": "SUBTITLE"}, "objectId": f"subtitle_{i}"},
                        ],
                    }
                })
                requests.append({
